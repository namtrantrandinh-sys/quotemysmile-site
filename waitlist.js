 ...
 *
 * INBOX is deliberately an address that EXISTS. It was hello@quotemysmile.com.au,
 * which has no mailbox behind it, so every reservation was posted into nothing.
 * Switch it the day that mailbox is real — run outreach/set_contact_email.py
 * --live, which moves this and the other eight files together. Prefer
 * FormSubmit's alias token over a raw address once you do: this file is public
 * and a plain address in client-side source gets scraped.
 *
